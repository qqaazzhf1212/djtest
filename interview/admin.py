...
def notify_interviewer(modeladmin, request, queryset):
    ...
    send_dingtalk_message.delay("候选人 {} 进入面试环节，亲爱的面试官，请准备好面试： {}".format(candidates, interviewers) )
...
class CandidateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('第一轮面试记录', {'fields': (
            ...
            "first_disadvantage", "first_recommend_position", "first_interviewer_user", "first_remark",)}),
        ('第二轮面试记录', {'fields': (
